...
<form method="POST">
    ...
    <div style="width:fit-content; margin:0 auto; padding:16px;">
        <div class="uiframe" style="width:1400px;">
            ...
            <div class="uigray" style="margin-top:8px; margin-bottom:16px; overflow-x:scroll;">
                ...
                <table class="excel" style="margin-top:16px; margin-bottom:16px; table-layout:fixed; box-shadow: 0px 3px 8px #BBBBBB">
                    <tr bgcolor="#F2F2F2" align="center">
                        ...
                        <td width="65px">F</td> <td width="35px">G</td> <td width="90px">H</td> <td width="60px">I</td> <td width="100px">J</td> <td width="100px">K</td>
                        <td width="50px">L</td> <td width="250px">M</td> <td width="50px">N</td> <td width="85px">O</td> <td width="85px">P</td> <td width="85px">Q</td>
                        <td width="85px">R</td> <td width="85px">S</td> <td width="85px">T</td> <td width="85px">U</td> <td width="170px">V</td> <td width="50px">W</td>
                    </tr>
                    <tr align="center">
