                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:normal">
                                        <div class="ui left pointing dropdown" style="padding:0px">
                                            ...
                                            <div class="menu">
                                                <a class="item name_change" data-id="<?= $teammate['id'] ?>" href="#">이름 변경</a>
                                                <a class="item birthday_change" data-id="<?= $teammate['id'] ?>" href="#">생년월일 변경</a>
                                                <a class="item team_change" data-id="<?= $teammate['id'] ?>" href="#">팀 변경</a>
                                                <a class="item teammate_remove" data-id="<?= $teammate['id'] ?>" href="#">팀원 삭제</a>
                                            </div>
                                        </div>
                                    </td>
