            ...
            <div class="uiframe"  style="width:800px">
                ...
                <div style="padding:16px;">
                    ...
                    <form action="" method="POST">
                        ...
                        <div style="margin-top:32px">테스트 현장의 생산성과 안전점수기록을 엑셀파일로 저장하시겠습니까?</div>
                        ...
                        <div style="text-align:right;">
                            <button class="bluebutton" type="submit" style="width:150px;" onclick="location.href='/fm/download_report'">다운로드</button>
                        </div>
